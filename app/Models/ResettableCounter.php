...
class ResettableCounter extends Model
{
    protected $fillable = [
        'name',
        'slug',
    ...
    {
        return $this->hasMany(UserCounter::class, 'counter_id');
    }
    ...
    /**
     * Scope to get only active counters
     */
    ...
    /**
     * Scope to get counters by reset frequency
     */
