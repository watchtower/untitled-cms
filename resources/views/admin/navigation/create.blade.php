...
<div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
    <div class="p-6">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold text-gray-900">Create Navigation Item</h1>
        ...
        <form method="POST" action="{{ route('admin.navigation.store') }}" class="space-y-6">
            @csrf
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div>
                        ...
                        >
                            ...
                            <option value="page" {{ old('type') === 'page' ? 'selected' : '' }}>Link to Page</option>
