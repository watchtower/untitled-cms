                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="hidden" id="selected-tag-ids" name="tag_ids" value="{{ old('tag_ids') }}">
...
function initTagInput() {
    ...
    // Load existing tag IDs if any
    if (selectedTagIdsInput.value) {
        const existingTagIds = selectedTagIdsInput.value.split(',').filter(id => id);
        selectedTags = availableTags.filter(tag => existingTagIds.includes(tag.id.toString()));
