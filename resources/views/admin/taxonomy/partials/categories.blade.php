                        ...
                        <tr class="hover:bg-gray-50" id="item-{{ $item->id }}">
                            ...
                            <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                                <div class="flex items-center justify-end space-x-2">
                                    ...
                                    <form method="POST" action="{{ route('admin.taxonomy.destroy', ['type' => 'category', 'id' => $item->id]) }}" class="inline">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" 
...
function editItem(id, name) {
    ...
    document.getElementById('edit-item-form').action = `/admin/taxonomy/category/${id}`;
