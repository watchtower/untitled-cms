...
<div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
    <div class="p-6">
        ...
        <div class="flex justify-between items-center mb-6">
            <div>
                <h1 class="text-2xl font-bold text-purple-900">💎 Bytes Transactions</h1>
                <p class="text-sm text-gray-600 mt-1">Real-time token transaction analytics powered by InfluxDB</p>
            </div>
            <div class="flex items-center space-x-3">
                ...
                <a href="{{ route('admin.analytics.transactions.export', ['type' => 'token', 'range' => $timeRange, 'user_id' => $userId]) }}" 
                   class="inline-flex items-center px-3 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
                    📊 Export Data
                </a>
            </div>
        ...
        <div class="bg-gray-50 rounded-lg p-4 mb-6">
            <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div class="flex items-end">
                    <button type="submit" class="w-full bg-purple-600 hover:bg-purple-700 text-white font-medium py-2 px-4 rounded text-sm">
                        Apply Filters
                    </button>
                </div>
            </form>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            ...
            <div class="bg-purple-50 border border-purple-200 rounded-lg p-4">
                <h3 class="text-sm font-medium text-purple-800">Net Change</h3>
        ...
        <div class="bg-white border border-gray-200 rounded-lg overflow-hidden">
            <div class="bg-purple-50 px-6 py-4 border-b border-gray-200">
                <h3 class="text-lg font-medium text-purple-900">Transaction History</h3>
            </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Token Type</th>
                            ...
                            @foreach($formattedTransactions as $transaction)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        ...
                                        @else
                                            <span class="text-red-600">{{ number_format($transaction['amount']) }} 💎</span>
                                        @endif
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        {{ number_format($transaction['balance_before']) }} → {{ number_format($transaction['balance_after']) }}
                                    </td>
            ...
            @else
                <div class="p-8 text-center">
                    ...
                    <p class="text-gray-500 text-lg mb-2">No token transactions found</p>
            ...
            <div class="flex items-start">
                ...
                <div class="ml-3">
                    ...
                    <div class="mt-2 text-sm text-blue-700">
                        <p>This data is sourced directly from InfluxDB for optimal performance. All new token transactions are automatically recorded in real-time.</p>
                    </div>
                </div>
            </div>
        </div>
