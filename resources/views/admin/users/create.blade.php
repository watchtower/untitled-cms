        ...
        <form method="POST" action="{{ route('admin.users.store') }}" class="space-y-6">
            ...
            <div class="bg-gray-50 p-4 rounded-lg">
                ...
                <div class="space-y-2 text-xs text-gray-600">
                    <div><strong>Super Admin:</strong> Full system access including user management and system settings</div>
                    <div><strong>Admin:</strong> Content and user management (excluding system settings)</div>
                    <div><strong>Editor:</strong> Content creation and editing only</div>
                </div>
            </div>
